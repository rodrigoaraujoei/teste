...
const page = () => {
  ...
  return (
   ...
   <section id='home' className="text-black body-font bg-cover bg-center " style={{backgroundImage:"url('/hero.jpg')"}}>
  <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col md:items-start md:text-left items-center text-center">
    <div className="lg:max-w-sm lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0 bg-white p-10" data-aos="fade-up">
      <h1 className="title-font sm:text-5xl font-bold text-3xl mb-4 text-[#01AEF0]">Simplifying Your Life
      </h1>
      <div className=' border border-black mb-3' />
      <p className="mb-8 leading-relaxed" >Lavandaria - Engomadoria - Limpeza a Seco
Somos uma empresa especializada na lavagem e tratamento de todo o tipo de roupa, com limpeza tradicional, tratamento de nódoas, branqueamento, limpeza a seco e engomaria. 
Possibilidade de recolhas e entregas para toda a zona do Porto.
</p>
      {/* <div className="flex justify-start">
        <button className="inline-flex text-black bg-[#01AEF0] border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">Button</button>
...
<section id='service' className="text-black body-font">
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-col text-center w-full mb-20">
      <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-black">Serviço ao Domicílio</h1>
      <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Deixa a tua roupa nas mãos de profissionais especializados sem sair de casa.
Com a Washouse a trabalhar para ti, volta a ter tempo para fazer tudo aquilo que gostas, enquanto nós tratamos de toda a tua roupa.</p>
    </div>
    <div className="flex flex-wrap -m-4">
      <div className="lg:w-1/4 sm:w-1/2 p-4" data-aos="fade-down" data-aos-duration="1000">
        <div className="flex relative h-[400px]">
          <img alt="gallery" className="absolute inset-0 w-full h-full object-fit object-center" src="/s1.jpg" />
          <div className="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-100 transition-all">
            <h2 className="tracking-widest text-sm title-font font-medium text-[#01AEF0] mb-1">THE SUBTITLE</h2>
            <h1 className="title-font text-lg font-medium text-gray-900 mb-3">Shooting Stars</h1>
            <p className="leading-relaxed">Photo booth fam kinfolk cold-pressed sriracha leggings jianbing microdosing tousled waistcoat.</p>
          </div>
        </div>
      </div>
      <div className="lg:w-1/4 sm:w-1/2 p-4" data-aos="fade-down" data-aos-duration="2000">
        <div className="flex relative h-[400px]">
          <img alt="gallery" className="absolute inset-0 w-full h-full object-fit object-center" src="/s2.jpg" />
          <div className="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-100 transition-all">
            <h2 className="tracking-widest text-sm title-font font-medium text-[#01AEF0] mb-1">THE SUBTITLE</h2>
            <h1 className="title-font text-lg font-medium text-gray-900 mb-3">Shooting Stars</h1>
            <p className="leading-relaxed">Photo booth fam kinfolk cold-pressed sriracha leggings jianbing microdosing tousled waistcoat.</p>
      ...
      <div className="lg:w-1/4 sm:w-1/2 p-4" data-aos="fade-down" data-aos-duration="3000">
        <div className="flex relative h-[400px]">
          <img alt="gallery" className="absolute inset-0 w-full h-full object-fit object-center" src="/s3.jpg" />
          <div className="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-100 transition-all">
            <h2 className="tracking-widest text-sm title-font font-medium text-[#01AEF0] mb-1">THE SUBTITLE</h2>
            <h1 className="title-font text-lg font-medium text-gray-900 mb-3">Shooting Stars</h1>
            <p className="leading-relaxed">Photo booth fam kinfolk cold-pressed sriracha leggings jianbing microdosing tousled waistcoat.</p>
      ...
      <div className="lg:w-1/4 sm:w-1/2 p-4" data-aos="fade-down" data-aos-duration="4000">
        <div className="flex relative h-[400px]">
          <img alt="gallery" className="absolute inset-0 w-full h-full object-fit object-center" src="/s4.jpg" />
          <div className="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-100 transition-all">
            <h2 className="tracking-widest text-sm title-font font-medium text-[#01AEF0] mb-1">THE SUBTITLE</h2>
            <h1 className="title-font text-lg font-medium text-gray-900 mb-3">Shooting Stars</h1>
            <p className="leading-relaxed">Photo booth fam kinfolk cold-pressed sriracha leggings jianbing microdosing tousled waistcoat.</p>
...
<section className="bg-gray-100">
  ...
  <div className="lg:flex lg:items-center justify-center mb-10">
     
        <div>
          <h1 className="text-2xl text-center font-semibold capitalize lg:text-3xl text-black">explore our awesome Components</h1>
          <div className="mt-2 text-center">
            <span className="inline-block w-40 h-1 bg-[#01AEF0] rounded-full" />
            <span className="inline-block w-3 h-1 ml-1 bg-[#01AEF0] rounded-full" />
            <span className="inline-block w-1 h-1 ml-1 bg-[#01AEF0] rounded-full" />
          </div>
    ...
    <div className="lg:flex lg:items-center lg:justify-center">
      <div className="w-full space-y-12 lg:w-1/2 ">
        <div className="md:flex md:items-start lg:items-center md:-mx-4" data-aos="fade-left" data-aos-duration="1000">
          <span className="inline-block p-2 text-[#01AEF0]  rounded-xl md:mx-4 bg-[#01AEF0]">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" fill="fillCurrent" viewBox="0 0 24 24" stroke="currentColor">
...
5€/kg de roupa (mínimo 5kg)
        ...
        <div className="md:flex md:items-start lg:items-center md:-mx-4" data-aos="fade-left" data-aos-duration="1000">
          ...
          <div className="mt-4 md:mx-4 md:mt-0">
            <h1 className="text-xl font-semibold capitalize text-black">
            Serviço de Engomar</h1>
            <p className="mt-0 text-gray-600">
            Valor à peça. Consulte a tabela de preços em Engomadoria
        ...
        <div className="md:flex md:items-start lg:items-center md:-mx-4" data-aos="fade-left" data-aos-duration="1000">
          ...
          <div className="mt-4 md:mx-4 md:mt-0">
            ...
            Limpeza a Seco</h1>
            <p className="mt-0 text-gray-600">
            Valor à peça. Consulte a tabela de preços Limpeza a Seco
        ...
        <div className="md:flex md:items-start lg:items-center md:-mx-4" data-aos="fade-left" data-aos-duration="1000">
          ...
          <div className="mt-4 md:mx-4 md:mt-0">
            <h1 className="text-xl font-semibold capitalize text-black">
            Limpeza de Tapetes/Carpetes</h1>
            <p className="mt-0 text-gray-600">
            *8,80€/m2
            </p>
            <p className="mt-3 text-gray-600">
...
<section className="text-gray-600 body-font">
  <div className=" mx-auto">
    ...
    <div className="flex lg:flex-row flex-wrap -mb-12 lg:text-right">
      <div className="lg:w-1/2 mb-10 p-10 py-7">
    <div className="flex flex-col text-center w-full mb-10 ">
      <h1 style={{textShadow:'1px 0px 5px white'}} className="md:text-5xl text-3xl font-bold title-font mb-4 text-black text-right">Limpeza a Seco</h1>
    </div>
     
        <div class="flex-grow">
          <h2 class="text-gray-600 text-lg title-font font-medium mb-3">Anim non reprehenderit qui dolore. 4.5€</h2>
        </div>
        <div class="flex-grow">
          <h2 class="text-gray-600 text-lg title-font font-medium mb-3">Almofada penas 14.5€</h2>
        </div>
        <div class="flex-grow">
          <h2 class="text-gray-600 text-lg title-font font-medium mb-3">Culpa fugiat sint sint officia enim magna nulla elit mollit aliquip 4.5€</h2>
        </div>
        <div class="flex-grow">
          <h2 class="text-gray-600 text-lg title-font font-medium mb-3">Anim non reprehenderit qui dolore. 4.5€</h2>
        </div>
        <div class="flex-grow">
          <h2 class="text-gray-600 text-lg title-font font-medium mb-3">Aliqua veniam dolore sunt consequat enim officia Lorem dolor occaecat cupidatat 4.5€</h2>
        </div>
        <div class="flex-grow">
          <h2 class="text-gray-600 text-lg title-font font-medium mb-3">Culpa fugiat sint sint officia enim magna nulla elit mollit aliquip 4.5€</h2>
        </div>
      ...
      <div className="lg:w-1/2 mb-10">
        <div className=" overflow-hidden">
          <img alt="content" className="object-cover object-center h-full w-full" src="/service.webp" />
        </div>
      </div>
    </div>
  </div>
</section>
<section id='limpeza' className="text-gray-600 body-font">
  <div className="px-5 py-2 mx-auto">
    <div className="flex lg:flex-row flex-col-reverse flex-wrap -mx-4 -mb-10 text-center">
      <div className="lg:w-1/2 mb-10">
        <div className="overflow-hidden">
          <img alt="content" className="object-cover object-center h-full w-full" src="https://images.unsplash.com/photo-1487744480471-9ca1bca6fb7d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80" />
        </div>
      
      </div>
      <div className="lg:w-1/2 mb-10 px-24 flex flex-col items-center justify-center">
        
        <h2 className="title-font text-4xl font-medium text-black mt-6 mb-3">
Limpeza de Tapetes  
</h2>
...
<section className="text-gray-600 body-font">
  <div className=" mx-auto">
    ...
    <div className="flex lg:flex-row flex-wrap -mb-12 lg:text-right">
      <div className="lg:w-1/2 mb-10 p-10 py-7">
    <div className="flex flex-col text-center w-full mb-10 ">
      <h1 style={{textShadow:'1px 0px 5px white'}} className="md:text-5xl text-3xl font-medium title-font mb-4 text-black text-right">Roupa de Cama</h1>
    </div>
     
        
        <div class="flex-grow">
          <h2 class="text-gray-600 text-lg title-font font-medium ">Almofada cheia 10.5€</h2>
        </div>
        <div class="flex-grow">
          <h2 class="text-gray-600 text-lg title-font font-medium ">Almofada Vazia 5€</h2>
        </div>
        <div class="flex-grow">
          <h2 class="text-gray-600 text-lg title-font font-medium ">Aliqua veniam  4.5€</h2>
        </div>
        <div class="flex-grow">
          <h2 class="text-gray-600 text-lg title-font font-medium ">Almofada cheia 10.5€</h2>
        </div>
        ...
        <div class="flex-grow">
          <h2 class="text-gray-600 text-lg title-font font-medium ">Almofada penas 14.5€</h2>
        </div>
        <div class="flex-grow">
          <h2 class="text-gray-600 text-lg title-font font-medium ">Culpa fugiat sint 4.5€</h2>
        </div>
        <div class="flex-grow">
          <h2 class="text-gray-600 text-lg title-font font-medium ">Anim non 4.5€</h2>
        </div>
        <div class="flex-grow">
          <h2 class="text-gray-600 text-lg title-font font-medium ">Anim non 4.5€</h2>
        </div>
...
<section id='limpeza' className="text-gray-600 body-font">
  <div className="px-5 py-2 mx-auto">
    <div className="flex lg:flex-row flex-col-reverse flex-wrap -mx-4 -mb-10 text-center">
      ...
      <div className="lg:w-1/2 mb-10 px-24 flex flex-col items-center justify-center">
        <div className='border-b border-gray-700 w-full py-2'>

        <h2 className="title-font text-4xl font-medium text-gray-700 mt-6 mb-3">
        Branqueamento de roupa  
</h2>
        <p className="leading-relaxed  text-center text-base text-gray-600">
        Aplicável a toda a roupa branca, edredons, coberturas de colchão</p>
        </div>
        <div className='border-b border-gray-700 w-full py-2'>
...
<p className="leading-relaxed  text-center text-base text-gray-600">
Entregue a sua roupa em loja e recolha já pronta, evitando o tempo de espera da lavagem e/ou secagem</p>
</div>
<div className='border-b border-gray-700 w-full py-2'>

<h2 className="title-font text-4xl font-medium text-gray-700 mt-6 mb-3">
Limpeza de cortinados/reposteiros  
</h2>
<p className="leading-relaxed  text-center text-base text-gray-600">
Desde 5€/m linear</p>
</div>
...
<ul className="leading-relaxed list-none text-center text-base text-gray-600">
<li >Alojamento Local&nbsp;</li><li >Hotelaria</li><li >Restauração</li>
</ul>
</div>
